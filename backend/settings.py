...
MIDDLEWARE = [
    ...
    'backend.apps.core.middleware.SecurityMiddleware',
    'backend.apps.core.middleware.InputValidationMiddleware',
]
...
if DATABASE_URL:
    ...
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.postgresql',
            'NAME': os.environ.get('PGDATABASE', os.environ.get('POSTGRES_DB', 'constructos')),
...
CACHES = {
    ...
    'sessions': {
        ...
        'KEY_PREFIX': 'constructos_session',
    },
}
